 ...
 * §File Path: wp.bjinsstabook.FldSelectClass
 * §Descrption: 点检标准应用程序-选择分类
 * §Version:  V0.1
 ...
 * ╚════════════════════════════════╝
 */
public class FldSelectClass extends MAXTableDomain {

    public FldSelectClass(MboValue mbv) {
        super(mbv);
