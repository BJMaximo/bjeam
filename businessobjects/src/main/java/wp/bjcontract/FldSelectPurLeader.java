 ...
 * §File Path: wp.bjcontract.FldSelectPurLeader
 * §Descrption: 合同管理应用程序-选择采购负责人
 * §Version:  V0.1
 ...
 * ╚════════════════════════════════╝
 */
public class FldSelectPurLeader extends MAXTableDomain {
    public FldSelectPurLeader(MboValue mbv) {
        super(mbv);
